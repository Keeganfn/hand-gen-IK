...
class ForwardKinematicsLIVE():
    ...
    def initialize_transforms(self):
        ...
        base_link_t = mh.create_translation_matrix(self.base_link_offset)
        base_link_r = mh.create_rotation_matrix(0)
        ...
        for i in range(1, len(self.link_lengths)):
            mat_t = mh.create_translation_matrix(self.link_lengths[i])
            mat_r = mh.create_rotation_matrix(0)
